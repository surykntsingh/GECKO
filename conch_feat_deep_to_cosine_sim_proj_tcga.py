...
parser = argparse.ArgumentParser()
parser.add_argument('--save_path', type=str, default = "/mnt/surya/dataset/TCGA_processed/gecko/features_conch_v1_cosine_sim_proj")
parser.add_argument('--feature_dir', type=str, default = "/mnt/surya/dataset/TCGA_processed/40x_512px_0px_overlap/features_conch_v1")
