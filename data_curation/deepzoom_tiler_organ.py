...
def organize_patches(img_slide, out_base, level=(0,), tile_size=448, overlap=0, limit_bounds=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--tile_size', type=int, default=448, help='tile size [448]')
    parser.add_argument('-m', '--magnifications', type=int, nargs='+', default=(1, ), help='Levels for patch extraction [0]')  # 3 for 5x, 2 for 10x, 1 for 20x, 0 for 40x.
